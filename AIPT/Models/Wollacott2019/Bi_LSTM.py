...
#         self.fc3 = nn.Linear(self.para_dict['hidden_dim'], 2)
#         # self.fc4 = nn.Linear(self.para_dict['out_dim']*self.para_dict['seq_len'], 2)
...
#         x = self.hidden(Xs)
#         # print(x.shape)
#         # x = x.reshape(self.para_dict['batch_size'], x.shape[1]*x.shape[2])
#         # out = self.fc4(x)
...
#     # data, out = loader.synthetic_data(num_samples=para_dict['num_samples'], seq_len=para_dict['seq_len'], aa_list='ACDEFGHIKLMNPQRSTVWY')
